...
public enum Lang {
  ...
  COMMAND_HELP_LINE_3("&eYou get one page by default, you can get more pages"),
  COMMAND_HELP_LINE_4("&eby subscribing to a premium rank. To open your vault"),
  COMMAND_HELP_LINE_5("&erun the command &3/vault&e."),
